...
export default function CustomerBottomNav({ cartCount, onCallStaff }: CustomerBottomNavProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 flex items-center justify-around border-t border-neutral-100 bg-primary-50 py-3">
      <button
        type="button"
        onClick={onCallStaff}
        className="flex flex-col items-center gap-1 text-caption text-neutral-700"
      >
      ...
      <button
        ...
        className="relative flex flex-col items-center gap-1 text-caption text-neutral-700"
      >
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
